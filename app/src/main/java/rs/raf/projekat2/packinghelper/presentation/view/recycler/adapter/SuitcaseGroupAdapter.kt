...
class SuitcaseGroupAdapter(suitcaseGroupDiffItemCallback: SuitcaseGroupDiffItemCallback,
                           ...
                           private val addGroup: (SuitcaseGroup) -> Unit): ListAdapter<SuitcaseGroup, SuitcaseGroupViewHolder>(suitcaseGroupDiffItemCallback){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SuitcaseGroupViewHolder {
        ...
        return SuitcaseGroupViewHolder(containerView, {deleteGroup(getItem(it))}, {addGroup(getItem(it))})
    }
